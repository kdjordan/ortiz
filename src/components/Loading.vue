<template>
  <div class="loading">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200.51 578.74" class="svg">
    ...
    <path class="logo" d="M129.08,96.71a30.56,30.56,0,1,1-30.44,30.56,30.53,30.53,0,0,1,30.44-30.56m0-41a71.56,71.56,0,1,0,71.43,71.56,71.5,71.5,0,0,0-71.43-71.56Z" style="fill:#f59963"/></svg>
  </div>
</template>
